...
Это Proof of Concept. В коде могут быть ошибки, недоработки и платформенные проблемы. Я буду рад принять ваши исправления, тесты и улучшения документации во благо всего коммьюнити.
...
- Используйте отдельный кошелёк с небольшим TON balance, не основной кошелёк.
